...
namespace QuanLyLopHoc.Migrations
{
    ...
    [Migration("20230514101035_db-15")]
    partial class db15
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuanLyLopHoc.Models.Entities.ContentPost", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("QuanLyLopHoc.Models.Entities.ContentReply", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("QuanLyLopHoc.Models.Entities.ContentPost", b =>
                {
                    b.HasOne("QuanLyLopHoc.Models.Entities.Post", "OriginalPost")
                        .WithMany("Contents")
            ...
            modelBuilder.Entity("QuanLyLopHoc.Models.Entities.ContentReply", b =>
                {
                    b.HasOne("QuanLyLopHoc.Models.Entities.Reply", "OriginalReply")
                        .WithMany("Contents")
                        .HasForeignKey("ReplyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("OriginalReply");
                });
